...
<template>
    <div class="flex justify-center m-2 gap-x-2">
        <Button v-if="admin || maintainer || enseignant || dde || bde" class="px-4 py-2 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition duration-200" @click="goToAdmin()">Admin Panel</Button>

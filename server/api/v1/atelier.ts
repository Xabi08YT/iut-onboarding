    ...
    try {
        ...
        switch(method) {
            ...
            case "PUT":
                ...
                return new Response(JSON.stringify({message:"Atelier updated successfully."}), {status: 200});

            case "DELETE":
                await deleteAtelier(body);
                return new Response(JSON.stringify({message:"Atelier deleted successfully."}), {status: 200});
            default:
